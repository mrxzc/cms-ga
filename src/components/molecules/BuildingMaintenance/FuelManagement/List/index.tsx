              ...
              <table className="table-fixed custom-table">
                <thead className="table-head text-heading xs semibold-16">
                  <tr>
                    ...
                    <th className="text-center">Pengunaan BBM Existing</th>
                    <th className="text-center">Pengunaan BBM Update</th>
                    <th className="text-center">Tanggal Pengajuan</th>
                    <th className="text-center">Action</th>
                  </tr>
                </thead>
                ...
                <tbody className="table-body text-paragraph regular-14">
                  {data?.map((val: any, index, arr) => (
                    ...
                    >
                      ...
                      <td className="text-center min-w-[200px]">{val?.fuelConsumtionExisting}</td>
                      <td className="text-center min-w-[200px]">{val?.fuelConsumtionRequested}</td>
                      ...
                      <td className="text-center min-w-[100px] w-full">
                        <div className="flex justify-center">
                          <button
                            ...
                            className="mr-3"
                            onClick={() => {
                              router.push(`/building-management/building-maintenance/fuel-management/${val?.no}`)
                            }}
                          >
