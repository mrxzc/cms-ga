      ...
      <div className="px-4 py-8 ">
        <div className="bg-white px-6 py-3 rounded mb-4 flex items-center space-x-2">
          <button
            type="button"
            onClick={() => {
              router.push('/building-management/building-maintenance/branch-condition')
            }}
          >
            <div className="text-extra-small regular-12 text-[#235696]">
              Building Maintenance - Report Kondisi Cabang
            </div>
          </button>
                    ...
                    >
                      ...
                      >
                        ...
                        <div className={`${isDropdownOpen ? '' : 'hidden'}`}>
                          <div
                            className={`${isDropdownOpen ? '' : 'hidden'} bg-[#EFF2F5] border-t border-[#E6E5E6] p-3`}
                          >
                            <div className="pl-6">
