                ...
                <tbody className="table-body text-paragraph regular-14">
                  {data?.map((val: any, index, arr) => (
                    ...
                    >
                      ...
                      <td className="text-center min-w-[200px]">{val?.location}</td>
                      <td className="text-center min-w-[200px]">{val?.area}</td>
                      <td className="text-center min-w-[200px]">{val?.branch}</td>
                      <td className="text-center min-w-[300px]">{val?.category}</td>
                      ...
                      <td className="text-center min-w-[100px] w-full">
                        <div className="flex justify-end">
                          <button
                            ...
                            className="mr-3"
                            onClick={() => {
                              router.push(`/building-management/building-maintenance/manpower-cs/${val?.no}`)
                            }}
                          >
