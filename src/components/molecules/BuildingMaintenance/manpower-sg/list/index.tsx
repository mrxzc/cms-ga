    ...
    <div className="mb-[600px]">
      <div className="px-4 py-8">
        <div className="bg-white px-6 py-3 rounded mb-4 flex justify-between">
          <div className="text-extra-small regular-12">Building Management - Manpower SG</div>
          <div className="flex">
        ...
        <div className="bg-white rounded-lg mb-4 p-6 relative">
          <div className="text-heading s semibold-18 mb-6">Manpower SG</div>
                        ...
                        <td className="text-center min-w-[100px] w-full">
                          <div className="flex justify-center">
                            <button
                              ...
                              className="mr-1"
                              onClick={() => {
                                router.push(`/building-management/security-guard/manpower-sg/${val?.noId}`)
                              }}
                            >
