                ...
                <tbody className="table-body text-paragraph regular-14">
                  {data?.map((val: any, index, arr) => (
                    ...
                    >
                      ...
                      <td className="text-center min-w-[200px]">{val?.wasteWeightExisting}</td>
                      <td className="text-center min-w-[200px]">{val?.wasteWeightRequested}</td>
                      ...
                      <td className="text-center min-w-[100px] w-full">
                        <div className="flex justify-center">
                          <button
                            ...
                            className="mr-3"
                            onClick={() => {
                              router.push(`/building-management/building-maintenance/waste-management/${val?.no}`)
                            }}
                          >
