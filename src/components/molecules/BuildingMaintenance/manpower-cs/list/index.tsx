...
import { IBuildingManagementCleaningServiceList } from '@interfaces/building-management-cleaning-service'
import { EnumClass } from '@interfaces/enums'
import { useGetBuildingManagementCleaningServiceList } from '@services/building-management/cleaning-service/query'
...
export function List() {
  ...
  const { data: meta, isFetching } = useGetBuildingManagementCleaningServiceList(handleMappingParams())
  // Fetch List Asset
    ...
    <div className="mb-[600px]">
      <div className="px-4 py-8">
        <div className="bg-white px-6 py-3 rounded mb-4 flex justify-between">
          <div className="text-extra-small regular-12">Building Management - Manpower CS</div>
          <div className="flex">
        ...
        <div className="bg-white rounded-lg mb-4 p-6 relative">
          <div className="text-heading s semibold-18 mb-6">Manpower CS</div>
              ...
              <table className="table-fixed custom-table">
                <thead className="table-head text-heading xs semibold-16">
                  <tr>
                    ...
                    <th className="text-center">Kategori Pengajuan</th>
                ...
                <tbody className="table-body text-paragraph regular-14">
                  ...
                  {!isFetching && meta?.data?.length ? (
                    meta?.data?.map((val: IBuildingManagementCleaningServiceList) => (
                      <tr key={`val-${val?.noId}`} className={`border-b border-[#E6E5E6]`}>
                        ...
                        <td className="text-center min-w-[250px]">{val?.kategoriRequest}</td>
                        ...
                        <td className="text-center min-w-[100px] w-full">
                          <div className="flex justify-center">
                            <button
                              ...
                              className="mr-1"
                              onClick={() => {
                                router.push(`/building-management/cleaning-service/manpower-cs/${val?.noId}`)
                              }}
                            >
                    ...
                    <tr>
                      <td colSpan={9} className="relative w-full h-48 min-w-[1430px] justify-center"></td>
                    </tr>
                  )}
                </tbody>
              </table>
