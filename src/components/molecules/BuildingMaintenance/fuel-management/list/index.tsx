...
import { IBuildingManagementFuelList } from '@interfaces/building-management-fuel'
import { EnumClass } from '@interfaces/enums'
import { useGetBuildingManagementFuelList } from '@services/building-management/fuel/query'
...
export function List() {
  ...
  const { data: meta, isFetching } = useGetBuildingManagementFuelList(handleMappingParams())
  // Fetch List Asset
    ...
    <div className="mb-[600px]">
      <div className="px-4 py-8">
        <div className="bg-white px-6 py-3 rounded mb-4 flex justify-between">
          <div className="text-extra-small regular-12">Building Management - Pengunaan BBM</div>
          <div className="flex">
        ...
        <div className="bg-white rounded-lg mb-4 p-6 relative">
          <div className="text-heading s semibold-18 mb-6">Pengunaan BBM</div>
              ...
              <table className="table-fixed custom-table">
                <thead className="table-head text-heading xs semibold-16">
                  <tr>
                    ...
                    <th className="text-center">BBM Existing</th>
                    <th className="text-center">BBM Request</th>
                ...
                <tbody className="table-body text-paragraph regular-14">
                  ...
                  {!isFetching && meta?.data?.length ? (
                    meta?.data?.map((val: IBuildingManagementFuelList) => (
                      <tr key={`val-${val?.noId}`} className={`border-b border-[#E6E5E6]`}>
                        ...
                        <td className="text-center min-w-[250px]">{val?.bbmExisting} Liter</td>
                        <td className="text-center min-w-[250px]">{val?.bbmRequest} Liter</td>
                        ...
                        <td className="text-center min-w-[100px] w-full">
                          <div className="flex justify-center">
                            <button
                              ...
                              className="mr-1"
                              onClick={() => {
                                router.push(`/building-management/ehs/fuel-management/${val?.noId}`)
                              }}
                            >
