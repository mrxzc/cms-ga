...
import { useGetDetailBastOut } from '@services/bast/query'
...
export function Detail() {
  ...
  const {
    ...
    isRefetchError,
    refetch,
  } = useGetDetailBastOut({ noIdSecurity: paramsPage?.noIdSecurity }, dataUser?.idUser)
    ...
    <div className="mb-[600px]">
      <div className="px-4 py-8 ">
        <div className="bg-white px-6 py-3 rounded mb-4 flex items-center space-x-2">
          ...
          <div className="text-extra-small regular-12 text-[#252525]">Form Keluar Kendaraan Detail</div>
        </div>

        <div className="bg-white rounded-lg mb-4 p-6 relative">
          <p className="text-heading s semibold-18 mb-10">Form Keluar Kendaraan</p>
          ...
          {isFetchSuccess && data?.data && (
            <>
              <div>
                ...
                <div className="grid grid-cols-4 gap-4 mb-6">
                  <p className="text-heading xs regular-16">Nama Security</p>
                  <div className="col-span-3">
