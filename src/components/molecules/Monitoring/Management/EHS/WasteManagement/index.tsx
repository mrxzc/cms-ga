...
export function MonitoringWasteManagement() {
  ...
  const columns = [
    ...
    columnHelper.accessor('beratSampahExisting', {
      cell: info => `${info.getValue()}`,
      header: 'Berat Sampah Existing',
    }),
    columnHelper.accessor('beratSampahRequest', {
      cell: info => `${info.getValue()}`,
  ...
  const breadcrumbs = [
    ...
    >
      Monitoring Pesanan - Waste Management
    </Link>,
  ]
  ...
  return (
    <div className="px-4 py-8 bg-[#f6f6f6] h-full w-full overflow-auto">
      ...
      <div className="bg-white px-4 py-4 rounded-xl">
        <p className="text-heading s semibold-18 mb-4">Monitoring Pesanan - Waste Management</p>
