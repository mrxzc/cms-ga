...
export function MonitoringFuelManagement() {
  ...
  const breadcrumbs = [
    ...
    >
      Monitoring Pesanan - Penggunaan BBM
    </Link>,
  ]
  ...
  return (
    <div className="px-4 py-8 bg-[#f6f6f6] h-full w-full overflow-auto">
      ...
      <div className="bg-white px-4 py-4 rounded-xl">
        <p className="text-heading s semibold-18 mb-4">Monitoring Pesanan - Penggunaan BBM</p>
