    ...
    <div className="mb-[600px]">
      <div className="px-4 py-8">
        <div className="bg-white px-6 py-3 rounded mb-4 flex justify-between">
          <div className="text-extra-small regular-12">Monitoring Pesanan - Report Kondisi Cabang</div>
          <div className="flex">
        ...
        <div className="bg-white rounded-lg mb-4 p-6 relative">
          <div className="text-heading s semibold-18 mb-6">Monitoring Pesanan - Report Kondisi Cabang</div>
              ...
              <table className="table-fixed custom-table">
                <thead className="table-head text-heading xs semibold-16">
                  <tr>
                    ...
                    <th className="text-center">Foto Kondisi Cabang</th>
                    <th className="text-center">Tanggal Pengajuan</th>
                    <th className="text-center">Action</th>
                  </tr>
                </thead>
                ...
                <tbody className="table-body text-paragraph regular-14">
                  {data?.map((val: any, index, arr) => (
                    ...
                    >
                      ...
                      <td className="text-center min-w-[200px]">{val?.photoSubmitted}</td>
                      ...
                      <td className="text-center min-w-[100px] w-full">
                        <div className="flex justify-center">
                          <button
                            ...
                            className="mr-3"
                            onClick={() => {
                              router.push(`/monitoring/branch-condition/${val?.no}`)
                            }}
                          >
