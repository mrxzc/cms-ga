...
export function List() {
  ...
  const { data, isFetching } = useGetListBallroom(handleMappingParams())
  // Fetch List Ballroom
  ...
  const { data: status, isFetching: isStatusFetching } = useGetListBallroomMonitoringStatus(statusParams)
  // Fetch List Status
    ...
    <div className="mb-[600px]">
      <div className="px-4 py-8">
        <div className="bg-white px-6 py-3 rounded mb-4 flex justify-between">
          <div className="text-extra-small regular-12">Monitoring Pesanan - Ballroom</div>
          <div className="flex">
        ...
        <div className="bg-white rounded-lg mb-4 p-6 relative">
          <div className="text-heading s semibold-18 mb-6">Monitoring Pesanan - Ballroom</div>
            ...
            <div className="rounded-lg border border-[#E6E5E6] overflow-auto">
              <table className="table-fixed custom-table">
                ...
                <tbody className="table-body text-paragraph regular-14">
                  ...
                  {!isFetching && data?.data?.length ? (
                    data?.data?.map((val: IMonitoringBallroomList) => (
                      <tr key={`val-${val?.idBooking}`} className={`border-b border-[#E6E5E6]`}>
                        ...
                        <td className="text-center min-w-[200px]">{val?.totalAsset}</td>
                        ...
                        <td className="text-center min-w-[100px] w-full">
                          <div className="flex justify-end mr-3">
                            <button
                              ...
                              className="mr-3"
                              onClick={() => {
                                router.push(`/monitoring/ballroom/${val?.idBooking}`)
                              }}
                            >
