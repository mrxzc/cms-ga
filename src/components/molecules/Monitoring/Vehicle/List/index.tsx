    ...
    <div className="mb-[600px]">
      <div className="px-4 py-8">
        <div className="bg-white px-6 py-3 rounded mb-4 flex justify-between">
          <div className="text-extra-small regular-12">Monitoring Pesanan - Vehicle</div>
          <div className="flex">
        ...
        <div className="bg-white rounded-lg mb-4 p-6 relative">
          <div className="text-heading s semibold-18 mb-6">Monitoring Pesanan - Vehicle</div>
                ...
                <tbody className="table-body text-paragraph regular-14">
                  {data?.map((val: any, index, arr) => (
                    ...
                    >
                      ...
                      <td className="text-center min-w-[250px]">{val?.type}</td>
                      <td className="text-center min-w-[300px]">{val?.detailUnit}</td>
                      <td className="text-center min-w-[200px]">{val?.brand}</td>
                      <td className="text-center min-w-[200px]">{val?.vehicleType}</td>
                      <td className="text-center min-w-[100px]">{val?.year}</td>
