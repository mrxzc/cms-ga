    ...
    <div className="mb-[600px]">
      <div className="px-4 py-8">
        <div className="bg-white px-6 py-3 rounded mb-4 flex justify-between">
          <div className="text-extra-small regular-12">Monitoring Pesanan - Pengajuan Perbaikan</div>
          <div className="flex">
        ...
        <div className="bg-white rounded-lg mb-4 p-6 relative">
          <div className="text-heading s semibold-18 mb-6">Monitoring Pesanan - Pengajuan Perbaikan</div>
              ...
              <table className="table-fixed custom-table">
                <thead className="table-head text-heading xs semibold-16">
                  <tr>
                    ...
                    <th className="text-center">Estimasi Cost</th>
                    <th className="text-center">Deskripsi Pengajuan</th>
                    <th className="text-center">Tanggal Pengajuan</th>
                    <th>
                      <div className="text-center flex items-center justify-center space-x-2">
                        <span>Status</span>
                ...
                <tbody className="table-body text-paragraph regular-14">
                  {data?.map((val: any, index, arr) => (
                    ...
                    >
                      ...
                      <td className="text-center min-w-[200px]">{val?.branch}</td>
                      <td className="text-center min-w-[250px]">{val?.estimationCost}</td>
                      <td className="text-center min-w-[300px]">{val?.description}</td>
                      ...
                      <td className="text-center min-w-[100px] w-full">
                        <div className="flex justify-center">
                          <button
                            ...
                            className="mr-3"
                            onClick={() => {
                              router.push(`/monitoring/vehicle/${val?.no}`)
                            }}
                          >
