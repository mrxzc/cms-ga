...
export function List() {
  ...
  const [selectedRoomFloor, setSelectedRoomFloor] = useState<IGcmRoomFloor>()
    ...
    <div className="mb-[600px]">
      <div className="px-4 py-8">
        <div className="bg-white px-6 py-3 rounded mb-4 flex justify-between">
          <div className="text-extra-small regular-12">Master Data - Manage Lantai Ruangan</div>
          <div className="flex">
        ...
        <div className="bg-white rounded-lg mb-4 p-6 relative">
          <div className="text-heading s semibold-18 mb-6">Master Data Lantai Ruangan</div>
            ...
            <div className="relative mb-6">
              <div className="rounded-lg border border-[#E6E5E6] overflow-auto">
                <table className="table-fixed custom-table">
                  ...
                  <tbody className="table-body text-paragraph regular-14">
                    {data?.data?.map((location: IGcmRoomFloor, index, arr) => (
                      <tr
                        ...
                        <td className="text-center min-w-[360px] w-full">
                          <label className="switch">
                            <input
                              ...
                              type="checkbox"
                              onChange={val => {
                                const payload: IGcmRoomFloorToggleStatusPayload = {
                                  noSr: location?.noSr,
                        ...
                        <td className="text-center min-w-[100px] w-full">
                          <div className="float-right">
                            <button
                              ...
                              className="mr-3"
                              onClick={() => {
                                router.push(`/master/room-floor/${location?.noSr}/edit`)
                              }}
                            >
                ...
                <button
                  ...
                  onClick={() => {
                    if (selectedRoomFloor) {
                      const payload: IGcmRoomFloorDeletePayload = {
                        noSr: selectedRoomFloor?.noSr,
                        flagActive: false,
                      }
