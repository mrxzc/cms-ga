...
export function Edit() {
  ...
  const paramsPage = useParams<{ location: string }>()
  ...
  const {
    ...
    isRefetchError,
    refetch,
  } = useGetLocationDetail({ noSr: paramsPage?.location })
  ...
  const onSubmit = (form: IGcmLocationUpdateForm) => {
    const payload: IGcmLocationUpdatePayload = { ...form }
    ...
    <div className="mb-[600px]">
      <div className="px-4 py-8 ">
        <div className="bg-white px-6 py-3 rounded mb-4 flex items-center space-x-2">
          ...
          <div className="text-extra-small regular-12 text-[#252525]">Edit Lokasi</div>
        </div>
