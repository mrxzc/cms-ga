...
export function Edit() {
  ...
  const breadcrumbs = [
    <Link href="/master/location" key="1" className="text-heading m semibold-21 text-[#235696] hover:underline">
      Master Data - Manage Lokasi
    </Link>,
  ...
  return (
    <div className="px-4 py-8 bg-[#f6f6f6] h-screen w-full overflow-y-auto">
      ...
      <div className="bg-white px-4 py-4 rounded-xl">
        <p className="text-heading s semibold-18 mb-4">Edit Lokasi</p>
