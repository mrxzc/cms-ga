...
export function List() {
  ...
  const [selectedCarYear, setSelectedCarYear] = useState<IGcmCarYear>()
  ...
  const [params, setParams] = useState<IGcmCarYearListParams>(defaultParams)

  const { data, isFetching, refetch } = useGetCarYear(params)
    ...
    <div className="mb-[600px]">
      <div className="px-4 py-8">
        <div className="bg-white px-6 py-3 rounded mb-4 flex justify-between">
          <div className="text-extra-small regular-12">Master Data - Manage Year</div>
          <div className="flex">
            ...
            <button
              ...
              onClick={() => router.push('/master/car-year/add')}
            >
        ...
        <div className="bg-white rounded-lg mb-4 p-6 relative">
          <div className="text-heading s semibold-18 mb-6">Master Data Year</div>
            ...
            <div className="relative mb-6">
              <div className="rounded-lg border border-[#E6E5E6] overflow-auto">
                <table className="table-fixed custom-table">
                  ...
                  <tbody className="table-body text-paragraph regular-14">
                    {data?.data?.map((location: IGcmCarYear, index, arr) => (
                      <tr
                        ...
                        <td className="text-center min-w-[360px] w-full">
                          <label className="switch">
                            <input
                              ...
                              type="checkbox"
                              onChange={val => {
                                const payload: IGcmCarYearToggleStatusPayload = {
                                  noSr: location?.noSr,
                        ...
                        <td className="text-center min-w-[100px] w-full">
                          <div className="float-right">
                            <button
                              ...
                              className="mr-3"
                              onClick={() => {
                                router.push(`/master/car-year/${location?.noSr}/edit`)
                              }}
                            >
            ...
            <div className="bg-white relative p-6 text-center rounded-xl justify-center">
              ...
              <div className="flex justify-center items-center space-x-3">
                ...
                <button
                  ...
                  onClick={() => {
                    if (selectedCarYear) {
                      const payload: IGcmCarYearDeletePayload = {
                        noSr: selectedCarYear?.noSr,
                        flagActive: false,
                      }
