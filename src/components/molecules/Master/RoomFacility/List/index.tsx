...
import { mutateDeleteRoomFacility, mutateToggleStatusRoomFacility } from '@services/gcm/roomFacility/mutation'
import { useGetRoomFacility } from '@services/gcm/roomFacility/query'
...
export function List() {
  ...
  const [selectedRoomFacility, setSelectedRoomFacility] = useState<IGcmRoomFacility>()
  ...
  const { mutate: mutateToggle, isSuccess: isToggleSuccess, reset: toggleReset } = mutateToggleStatusRoomFacility()
  const {
    mutate: mutateDelete,
    isPending: isDeletePending,
    isSuccess: isDeleteSuccess,
    reset: deleteReset,
  } = mutateDeleteRoomFacility()
    ...
    <div className="mb-[600px]">
      <div className="px-4 py-8">
        <div className="bg-white px-6 py-3 rounded mb-4 flex justify-between">
          <div className="text-extra-small regular-12">Master Data - Manage Fasilitas Ruangan</div>
          <div className="flex">
            ...
            <button
              ...
              onClick={() => router.push('/master/room-facility/add')}
            >
        ...
        <div className="bg-white rounded-lg mb-4 p-6 relative">
          <div className="text-heading s semibold-18 mb-6">Master Data Fasilitas Ruangan</div>
            ...
            <div className="relative mb-6">
              <div className="rounded-lg border border-[#E6E5E6] overflow-auto">
                <table className="table-fixed custom-table">
                  ...
                  <tbody className="table-body text-paragraph regular-14">
                    {data?.data?.map((location: IGcmRoomFacility, index, arr) => (
                      <tr
                        ...
                        <td className="text-center min-w-[360px] w-full">
                          <label className="switch">
                            <input
                              ...
                              type="checkbox"
                              onChange={val => {
                                const payload: IGcmRoomFacilityToggleStatusPayload = {
                                  noSr: location?.noSr,
                        ...
                        <td className="text-center min-w-[100px] w-full">
                          <div className="float-right">
                            <button
                              ...
                              className="mr-3"
                              onClick={() => {
                                router.push(`/master/room-facility/${location?.noSr}/edit`)
                              }}
                            >
                            ...
                            <button
                              type="button"
                              onClick={() => {
                                setSelectedRoomFacility(location)
            ...
            <div className="bg-white relative p-6 text-center rounded-xl justify-center">
              ...
              <div className="grid grid-cols-2 gap-2 justify-items-center">
                ...
                <button
                  ...
                  type="button"
                  onClick={() => {
                    if (selectedRoomFacility) {
                      const payload: IGcmRoomFacilityDeletePayload = {
                        noSr: selectedRoomFacility?.noSr,
                        flagActive: false,
                      }
