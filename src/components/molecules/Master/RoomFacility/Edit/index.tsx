...
export function Edit() {
  ...
  const paramsPage = useParams<{ roomFacility: string }>()
  ...
  const {
    ...
    isRefetchError,
    refetch,
  } = useGetRoomFacilityDetail({ noSr: paramsPage?.roomFacility }, dataUser?.idUser)
  ...
  const onSubmit = (form: IGcmRoomFacilityUpdateForm) => {
    const payload: IGcmRoomFacilityUpdatePayload = { ...form }
    ...
    <div className="mb-[600px]">
      <div className="px-4 py-8 ">
        <div className="bg-white px-6 py-3 rounded mb-4 flex items-center space-x-2">
          ...
          <div className="text-extra-small regular-12 text-[#252525]">Edit Fasilitas Ruangan</div>
        </div>

        <div className="bg-white rounded-lg mb-4 p-6 relative">
          <p className="text-heading s semibold-18 mb-10">Edit Fasilitas Ruangan</p>
